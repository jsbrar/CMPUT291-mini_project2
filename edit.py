...
def queryl4(oper, value, pile=[]):
    ...
    if len(pile) != 0:
        ...
        while iter != None:
            ...
            if ((temp[0] < date[0]) or (temp[0] == date[0] and temp[1] < date[1]) or (temp[0] == date[0] and temp[1] == date[1] and temp[2] <= date[2])) and key == 0 and aid[0] in pile: 
                new_pile.append(aid[0]) 
            elif ((temp[0] > date[0]) or (temp[0] == date[0] and temp[1] > date[1]) or (temp[0] == date[0] and temp[1] == date[1] and temp[2] >= date[2])) and key == 1 and aid[0] in pile:
                new_pile.append(aid[0])
            elif temp == date and key == 2 and aid[0] in pile:
                new_pile.append(aid[0])
            elif ((temp[0] < date[0]) or (temp[0] == date[0] and temp[1] < date[1]) or (temp[0] == date[0] and temp[1] == date[1] and temp[2] < date[2])) and key == 3 and aid[0] in pile:
                new_pile.append(aid[0])
            elif ((temp[0] > date[0]) or (temp[0] == date[0] and temp[1] > date[1]) or (temp[0] == date[0] and temp[1] == date[1] and temp[2] > date[2])) and key == 4 and aid[0] in pile:
                new_pile.append(aid[0])
            iter = curs.next()
    else:
        iter = curs.first()
...
def queryl6(oper, value, pile=[]):
    ...
    if len(pile) != 0:
        ...
        while iter != None:
            ...
            if int(iter[0].decode("utf-8")) <= value and key == 0 and aid[0] in pile:
                new_pile.append(aid[0])
            elif int(iter[0].decode("utf-8")) >= value and key == 1 and aid[0] in pile:
                new_pile.append(aid[0])
            elif int(iter[0].decode("utf-8")) == value and key == 2 and aid[0] in pile:
                new_pile.append(aid[0])
            elif int(iter[0].decode("utf-8")) < value and key == 3 and aid[0] in pile:
                new_pile.append(aid[0])
            elif int(iter[0].decode("utf-8")) > value and key == 4 and aid[0] in pile:
                new_pile.append(aid[0])
            iter = curs.next()
    else:
        iter = curs.first()
